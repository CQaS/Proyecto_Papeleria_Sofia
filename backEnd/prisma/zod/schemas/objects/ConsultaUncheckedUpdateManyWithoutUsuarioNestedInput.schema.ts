...
const Schema: z.ZodType<Prisma.ConsultaUncheckedUpdateManyWithoutUsuarioNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ConsultaUncheckedUpdateManyWithoutUsuarioNestedInputObjectSchema =
  Schema;
