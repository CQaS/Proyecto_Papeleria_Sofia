...
const Schema: z.ZodType<Prisma.ConsultaUncheckedCreateNestedManyWithoutUsuarioInput> =
  z
    .object({
      create: z
        .union([
...
export const ConsultaUncheckedCreateNestedManyWithoutUsuarioInputObjectSchema =
  Schema;
