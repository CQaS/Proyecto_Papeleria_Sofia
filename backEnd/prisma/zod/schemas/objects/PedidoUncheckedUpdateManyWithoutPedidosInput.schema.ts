...
const Schema: z.ZodType<Prisma.PedidoUncheckedUpdateManyWithoutPedidosInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const PedidoUncheckedUpdateManyWithoutPedidosInputObjectSchema = Schema;
