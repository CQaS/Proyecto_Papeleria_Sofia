...
const Schema: z.ZodType<Prisma.NestedEnumEstadoProductoWithAggregatesFilter> = z
  .object({
...
export const NestedEnumEstadoProductoWithAggregatesFilterObjectSchema = Schema;
