...
const Schema: z.ZodType<Prisma.PromoProductoCreateNestedManyWithoutPromocionInput> =
  z
    .object({
      create: z
        .union([
...
export const PromoProductoCreateNestedManyWithoutPromocionInputObjectSchema =
  Schema;
