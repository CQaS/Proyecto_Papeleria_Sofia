...
const Schema: z.ZodType<Prisma.PromoProductoUpdateManyWithoutProductoNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PromoProductoUpdateManyWithoutProductoNestedInputObjectSchema =
  Schema;
