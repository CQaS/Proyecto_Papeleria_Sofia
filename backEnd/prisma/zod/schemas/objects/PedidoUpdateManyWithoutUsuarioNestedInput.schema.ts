...
const Schema: z.ZodType<Prisma.PedidoUpdateManyWithoutUsuarioNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => PedidoUpdateManyWithWhereWithoutUsuarioInputObjectSchema),
        z
          .lazy(() => PedidoUpdateManyWithWhereWithoutUsuarioInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const PedidoUpdateManyWithoutUsuarioNestedInputObjectSchema = Schema;
