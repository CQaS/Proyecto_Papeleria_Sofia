...
const Schema: z.ZodType<Prisma.PromoProductoUncheckedUpdateManyWithoutPromocionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PromoProductoUncheckedUpdateManyWithoutPromocionNestedInputObjectSchema =
  Schema;
