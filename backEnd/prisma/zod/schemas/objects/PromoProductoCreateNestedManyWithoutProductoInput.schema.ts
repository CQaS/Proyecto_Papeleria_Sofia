...
const Schema: z.ZodType<Prisma.PromoProductoCreateNestedManyWithoutProductoInput> =
  z
    .object({
      create: z
        .union([
...
export const PromoProductoCreateNestedManyWithoutProductoInputObjectSchema =
  Schema;
