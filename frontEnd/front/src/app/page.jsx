        ...
        <section className="pt-20 relative">
          <div className="w-full h-[600px] relative">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://readdy.ai/api/search-image?query=A%20bright%2C%20organized%20stationery%20store%20interior%20with%20colorful%20school%20supplies%20neatly%20arranged%20on%20shelves.%20Natural%20light%20streaming%20through%20windows%2C%20highlighting%20vibrant%20notebooks%2C%20pens%2C%20and%20art%20supplies.%20The%20space%20feels%20warm%2C%20creative%20and%20inviting%2C%20with%20a%20clean%20modern%20aesthetic.%20Left%20side%20of%20the%20image%20should%20have%20a%20clean%20white%20background%20that%20gradually%20transitions%20to%20the%20stationery%20store%20scene.&width=1600&height=800&seq=12345&orientation=landscape')",
            ...
            <div className="container mx-auto px-4 h-full flex items-center">
              <div className="max-w-2xl relative z-10 bg-white/90 p-8 rounded-lg backdrop-blur-sm">
                ...
                <p className="text-lg md:text-xl text-gray-700 mb-8">
                  Tu nuevo espacio para encontrar útiles escolares, promociones
                  y servicios de impresión y encuadernación.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-gray-600 mb-8">
                ...
                También ofrecemos servicios de encuadernación, plastificado y
                más para tus documentos importantes.
              </p>
        ...
        <footer className="bg-gray-900 text-white pt-12 pb-6">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              <div>
                <h3 className="text-xl font-['Pacifico'] mb-4">
                  Papelería SOFIA
                </h3>
